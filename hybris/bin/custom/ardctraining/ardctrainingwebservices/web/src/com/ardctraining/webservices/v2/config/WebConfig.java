 ...
 */
package com.ardctraining.webservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.ardctraining.webservices.constants.YcommercewebservicesConstants;
import com.ardctraining.webservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "ardctrainingwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "ardctrainingwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "ardctrainingwebservices.oauth2.tokenUrl";

	private static final String DESC = "ardctrainingwebservices.v2.description";
	private static final String TITLE = "ardctrainingwebservices.v2.title";
	private static final String VERSION = "ardctrainingwebservices.v2.version";
	private static final String LICENSE = "ardctrainingwebservices.v2.license";
	private static final String LICENSE_URL = "ardctrainingwebservices.v2.license.url";
